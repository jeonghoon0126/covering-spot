    ...
    >
      <div className="px-6 max-sm:px-4 flex justify-between items-center w-full">
        ...
        <div className="flex items-center gap-0.5">
          ...
          <Link
            href="/booking/manage"
            className="ml-1 inline-flex items-center gap-1.5 bg-bg-warm text-text-primary text-[13px] font-semibold px-4 py-2.5 rounded-xl no-underline transition-all hover:bg-bg-warm2 active:scale-[0.97] border border-border-light"
          >
            신청 조회
          </Link>
          {canInstall ? (
            <button
              onClick={install}
              className="ml-1.5 inline-flex items-center gap-1.5 bg-text-primary text-white text-[13px] font-semibold px-4 py-2.5 rounded-xl no-underline transition-all hover:bg-brand-800 hover:shadow-md active:scale-[0.97]"
            >
